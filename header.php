                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                      ...
                      <?php if ($account->checkPermission('SETTING_TOOLS')){ ?>
                          <li>
                              <a href="settings">
                                  <i class="fa fa-cogs fa-fw"></i> Setting
                              </a>
                          </li>
                          <li class="divider"></li>
                      <?php }?>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      ...
                      <?php if ($account->checkPermission('BOARD_PENDING')){ ?>
                        <li>
                            <a href="pending">
                              <i class="fa fa-clock-o fa-fw"></i> Pending
                            </a>
                        </li>
                      <?php }?>
                      <?php if ($account->checkPermission('BOARD_PROCESSING')){ ?>
                        <li>
                            <a href="processing">
                              <i class="fa fa-refresh fa-fw"></i> Processing
                            </a>
                        </li>
                      <?php }?>
                      ...
                      <?php if ($account->checkPermission('TRANSACTION_NEW_TRANSACTION')){ ?>
                        <li>
                            <a href="transaction">
                              <i class="fa fa-edit fa-fw"></i> New Transaction
                            </a>
                        </li>
                      <?php }?>
