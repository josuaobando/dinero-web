                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-header <?= $headerType ?>">
                      <h4 class="modal-title" id="myModalLabel">Please review the <?= $transactionType ?>
                        information</h4>
                    </div>
                      ...
                      <div class="panel-body">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane fade active in" id="tab-process<?= $id ?>">
                            <form role="form" data-toggle="validator" method="post" id="myForm<?= $id ?>"
                                  name="myForm<?= $id ?>" action="pending">
                              <table class="table">
                                <thead>
                                <tr>
                                  <th>ID</th>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-lg-6">
                                    ...
                                    <input class="form-control input-sm" type="number" id="amount" name="amount"
                                           step="any" min="1" value="<?= $amount ?>" required>
                                  </div>
                                  <div class="col-lg-6">
                                    <label>Control Number</label>
                                    <input class="form-control input-sm" type="text" id="control_number"
                                           name="control_number" value="<?= $controlNumber ?>" minlength="8"
                                           maxlength="11" pattern="<?= Util::REGEX_NUMERIC ?>" required>
                                  </div>
                                </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <input class="form-control input-sm" type="text" id="uid" name="uid"
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-lg-6">
                                    <label>Country</label>
                                    <input class="form-control input-sm" type="text" id="countryName" name="countryName"
                                           value="<?= $countryName ?>" readonly>
                                  </div>
                                  <div class="col-lg-6">
                                    <label>State</label>
                                    <input class="form-control input-sm" type="text" id="stateName" name="stateName"
